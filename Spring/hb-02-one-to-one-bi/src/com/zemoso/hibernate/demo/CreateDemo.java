...
*/
			...
			Instructor instructor=new Instructor("nani","bandi","nani@gmail.com");

			com.zemoso.hibernate.demo.entity.InstructorDetail instructorDetail=new InstructorDetail("http://nani/youtube","Watching Instagram");
